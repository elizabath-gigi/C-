...
public class UserController : ControllerBase
{
    ...
    public async Task<IActionResult> GetUserEmail(string email)
    {
        try
        {
            var response = await _userServices.GetUserEmail(email);
    ...
    public async Task<IActionResult> ValidateOtp(string email, string otp)
    {
        try
        {
            var response = await _userServices.ValidateOtp(email,otp);
    ...
    public async Task<IActionResult> ForgotPassword(string email,string newPassword)
    {
        try
        {
            var response = await _userServices.ForgotPassword(email, newPassword);
    ...
    public async Task<IActionResult> GetNameHindi(string UserName, string email)
    {
        var response = _userServices.GetNameHindi(UserName);
        if (response == null)
        {
